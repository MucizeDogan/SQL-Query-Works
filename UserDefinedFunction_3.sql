 -- Ondeceden de yapmýs oldugumuz aylarýn ayýný getirme islemini bu sefer fonksiyona baglayip asýl kod blogunda kullanýp duzenli bir kod yapisi elde edecegiz.
 ...
 BEGIN
	...
	IF DATEPART(MONTH,@DATE)=10 SET @RESULT='10.EKÝ'
...
RETURN @RESULT 
 ...
 SELECT DBO.MONTHNAME_('20230529')